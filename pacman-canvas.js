...
function geronimo() {
	...
	function Game() {
		...
		this.newGame = function () {
			var r = confirm("Sicuro che vuoi ricominciare?");
			if (r) {
		...
		this.nextLevel = function () {
			...
			game.showMessage("Level " + game.level, this.getLevelTitle() + "<br/>(Clicca per continuare!)");
		...
		this.pauseResume = function () {
			if (!this.running) {
				...
				this.showMessage("Pausa", "Clicca per tornare");
			}
		};
		...
		this.buildWalls = function () {
			if (this.ghostMode === 0) game.wallColor = "#01a8e8";
			else game.wallColor = "#f915ff";
